# Open this file in the ISE. Highlight one block and press F8 to
# execute just that block. 
...
# Note that the width restriction is ignored because there is space available
...
Format-Table @{n='DriveLetter';e={$PSItem.DeviceID}},
             @{n='FreeSpace(GB)';e={$PSItem.FreeSpace / 1GB};formatString='N2'},
             @{n='Size(GB)';e={$PSItem.Size / 1GB};formatString='N2'},
             @{n='Type';e={$PSItem.Description};width=5}
# Note that width is observed, but the columns are spaced to fill the screen
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUykPZE7qUk6tYyPDwQUfuhSdN
# XXSgghWCMIIEwzCCA6ugAwIBAgITMwAAADPlJ4ajDkoqgAAAAAAAMzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFOoo
# 8yrrENC8EugmbDglEQ+fviUmMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAIBockUYMop2B2yQ
# 1gG2Zs8KdgZVR+tOLXbZdcyplw9wZaFDyKhRMDYlE32+JonfgBW1VkovucH+0pj0
# Hdaq1AODycH4hTKhjssYJUiI5gZjgCsGsc7Sl4EP7FCZGNlqiHHz2KoJBRyUaLWt
# fZqyAxQ5R6WowQ+/JgmBrFh0CCRLyDHmv3zmdKPTHBYQeiLeIy28y8gzQa6Dy9V2
# qRnNwF/6otgMqSKL56yMDYpcbzWOmy2p4kNXbyx8t/HRTqAf2j2at/NLZivbwV2q
# YcKkOTrI/9qK3ocllk8MXLZkM6STGPaizTNOr+eKn6GJyTdEsD0vU+N97iUbPJ5T
# IXKQQPahggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MTcxMzAwMjVaMCMGCSqGSIb3DQEJBDEWBBR2oUPS19RYx52y0PatZMsRLKVzdDAN
# BgkqhkiG9w0BAQUFAASCAQCHOuY3AjEK+dv7IjDUMM+w+2FBMwccLxdfTUzzbbkp
# u9wwEBtHvBvLIwRzfTYOlyCtgo8SoCUpd9sgf1UtM3efKOhZdCjqox8UCmwh5M1/
# kGle0M7QhpEYdBQngy4cTlbqXkXvI3ylgUJO/VHessr/n9Z3WYJw69yXCFYiNCuY
# Ei8pYbRSE7RVGyYNAujW/Xy2mAnKhtpzzlosEc9j8Ypi6snLZvO3KiTSTRtfeIQk
# kpFGNxqgy0ddUworlNLqTv/vm3OcdWZnTbtdXINDsNWixPseH5yWF2xjSkqTMowe
# GXD4phRP1/CuzMjXRF/+lmNiwArZkXJY96ww9glD55PZ
