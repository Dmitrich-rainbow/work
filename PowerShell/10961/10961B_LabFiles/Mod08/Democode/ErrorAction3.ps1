# Run this entire script in the ISE.

Try {
    Get-WmiObject -Class Win32_BIOS -ComputerName LON-CL1,BAD,LON-CL1 -ErrorAction Stop -ErrorVariable MyErr
} Catch {
    Write-Host "Error while querying a computer. Stopping command."
    Write-Host "The error was: $MyErr"
} 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUNSvhNuOBIVu8EPvj4UfjHlJ8
# hPmgghWCMIIEwzCCA6ugAwIBAgITMwAAACs5MkjBsslI8wAAAAAAKzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFM0G
# lxgz2/gofygKFpL6YRrbrQ2QMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBALxDVp/9PqYUOmpL
# Yuq6mUXe3WTpe3AhPZRJh3Nfszn5UDcA8uM2Cii6iDXOtix1zKqLUO+hn5rTfiQ6
# K/bUUKJebOCfpUqGeHNdP0qU/J8VFI+5BiAdnaySi7sGcXhptYnDOY6URq9haU78
# ZDgqZG31+qrlSM39Y0xkIWQBBy+nBIvajeD+NR6TRpv6WzmoCE0n/Ffz7fL6TW0A
# u/PVjVYct5hyu15XyHtSbwt2d2vlcI/+mu3H9BzSnFDF6bd3fJdFdIb07OStqay9
# HF5nMC6SAPaXtZzhRNpAPqaLpKNLnEoZRbwWb9vynwgqHrkIo2P42ct+xluy63wv
# LvXiQUGhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MTcxMTQ2MDFaMCMGCSqGSIb3DQEJBDEWBBTAfHN+trkVwAx9QI6BNL0bLp1DgTAN
# BgkqhkiG9w0BAQUFAASCAQCKE5eLHHmUYICnFpugRtm2dbLdwcVBq2+nCQwQw3hU
# 7mCJcvWYh5XYvINURZ0rpSgnYfKKMDQTZNgdN+9g0KcYO5S+UMpeUoePPXdlr0PL
# ErD4bgsfvOEltSyR2ZxHsiiWLl1cYmmAhBd6auxJi/E5URlVbgMssddT0HzgfQrw
# 79uU8px6SZ7n8IFgnYQdWdjg5zIO08nBuqxMGd5OHdUyQNP4m/0jVgRKtm+vKDTl
# pubTkA1fXdVMcsre/TziVV7bVSO/gwY3NUU+HUdyuQwnAjlw7hL/koGi/vLrpzv4
# 5pqdBFYH4fSmWz8JhWTK4lyWJ9opmLrTZ3v8u2kM3G5Q
