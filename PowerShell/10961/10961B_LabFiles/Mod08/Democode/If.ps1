...
if ($drive.DriveType -eq 3) {
    Write "Drive is fixed local disk"
} elseif ($drive.DriveType -eq 5) {
    Write "Drive is an optical drive"
} else {
    Write- "Drive is of another type"
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUmxoefdGV1l75s76y6yOGyWRj
# YSWgghWCMIIEwzCCA6ugAwIBAgITMwAAADQkMUDJoMF5jQAAAAAANDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFB5K
# 7UILUuZFLbsJV3qt3he0DV9rMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBANwPdckdMGkaS+2e
# AbSQCARx4K9Pmutg+hysTXmyiDiJSD/YWHANYsZqBX8JA3i6LbniBhO92Gunb+gl
# 5Y9USDo4aObxKc58+hPK7boG2GJJMiEvy2xEPRYq0tNuJ3gk9geGp5aCF81tfsJj
# nXYAJlEVDudUV4NZuJln4TnQZCd4uLv57YNXAv6Qm6oeElK668Fu2ET+6D0rwrKC
# R3XF/rMc6HMVy8BIERv9th2S3LJU3YdGg4xtJ9dQwVh57Yi+cEBUA5IciPtmFYnR
# AVrb0NpNfJ8/sEYJGXV/KJYo7ea6undNF8GLUSzscrbFqtbi41lGhDVQJYUFM9G2
# OouFjbuhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MTcxMTQ2MDdaMCMGCSqGSIb3DQEJBDEWBBS/nEIxrEc2BOy4fwxziYuZC2C/lDAN
# BgkqhkiG9w0BAQUFAASCAQBhv7HucCIVZx5tTMr6lM1jmaPdgOopDcxjuDIC7Vse
# ImOQ57DSmxVoy94D7ctWJPURUMgMbKe2qdm4Wq9wXP6oN23psecS9k0O30lfVYHf
# +1VeuPnI3ZobdRDqVD259DCvp62p/d1G473zjP6UnP3rXWZJ2bmHWsVkNmb9sZCc
# PkIhUeMdi0DIq0chJwyLr225zzlK3wkF/Ae4dURIWi6YXwF0t6NUqegKseeiUDYo
# YBOX5JCKFl7Jq3ACvdPMZEqI8goH18wt1M0NG8zXHsPqc/I4JDAM1ZEGPW2wi13Z
# tgRfTbIxesF8PgvcmCLcC9bV5zDOCWry0F6UFA4FbxfM
