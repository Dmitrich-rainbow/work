function Get-RemoteSecurityEntry {
    [CmdletBinding()]
    Param(
    ...
    Try {
        Get-EventLog -LogName Security -Newest $MaxEntries -ErrorAction Stop -ComputerName $ComputerName |
...
Get-RemoteSecurityEntry -ComputerName BAD -Verbose
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQURUMLMYXIhlklf8xCo2mQgfOY
# ToOgghWCMIIEwzCCA6ugAwIBAgITMwAAACs5MkjBsslI8wAAAAAAKzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJH6
# TZJ/EmW2VaTaXKmmhI92kuRzMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAG3IsbFlhoKdboSy
# Ak2+5zmdszvdkBWSV4hRawLmHiKxHWE0+3TMU5+fQTW00KHhzanykceVw9c37OCT
# SR/fPsxrNcIq+yKupBRUvWrT0r6JMuu2Uj8B+Mxeu0getShvnuKC7/3n8btx5jZN
# hnlpOgSZNEOKoEB1Xiq9RjyiRI6X32Ah6ogHiZX+Nw+YdObqp4ckETBowBaqOadZ
# Z3znPKx6qja9qaYaRpHcmEF3BNzhfJ3BibMPJ8I8zCcKt/wS4ePiexkq+Kpdgaus
# y6tL+PBcNTjJAZC8XYtR5+fnHmwuqro0Sl0KXtpzaZnv6BfVXlHDB7fgGab+MqT5
# 2Av76EqhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MTcxMTQ2MDdaMCMGCSqGSIb3DQEJBDEWBBQ4CLKQCJMj2e7nWp0n4xSod9il/jAN
# BgkqhkiG9w0BAQUFAASCAQBhcZaomDnDPuScdvxqtvPhRJ9hCN64yivqCo/vHh/Q
# MmQUrl1JvdH2DHrYo0bpIOb6SsP434WpiMmUEf8ShsI8LHksZ8hjS2EgI9p6HvTI
# LSiC9D2Upv3zFBTpdA8AaV7hasW2v1bbJQYqAbBfXoe/GVH5e+8PC3Z+7JPZss93
# hH8oooQiIRKvQdQBYFrVdP4hAZlO9rwP/AEVZ51g0EOPh8VjFdYf6SytEMMDpFGP
# 4Hj8w05nYukOAFM20+JSjpHSuRfrMpT/Cj+5vcnCKB2Ldk9+2qiuaFDX/TL+kGrI
# Ek7PI+V8QvPY8wlFlUekz9wvKyvX2l70vHMnb1gjWrxd
