function Get-DiskInfo {
    ...
    .PARAMETER DriveType
    The type of drive to query. Defaults to 3,
    representing local fixed disks.
    .EXAMPLE
...
function Get-OSInfo {
    ...
    ForEach ($name in $ComputerName) {
        Try {
            Get-CimInstance -ClassName Win32_OperatingSystem -ErrorAction Stop -ComputerName $name |
            Select-Object @{n='ComputerName';e={$PSItem.PSComputerName}},
                          @{n='SPVersion';e={$PSItem.ServicePackMajorVersion}},
                          @{n='OSVersion';e={$PSItem.Version}},
                          @{n='OSBuild';e={$PSItem.BuildNumber}}
        } Catch {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUe5pi/wIKkll/Op6TpZoNJ6cW
# ezKgghWCMIIEwzCCA6ugAwIBAgITMwAAADQkMUDJoMF5jQAAAAAANDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFKVd
# Lw/o+AYZ5/KBsoacB6oFkKFSMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAIZay8tz1bwX+rTc
# 6X5J+Un3r+EomS9f5k4qUyzXyRJzDP0KikKB95b2Eebbo5xSPjZyFt8WDMw7HHfo
# urqQJ/bgkxDK3Afuh6rEr4MmqsMRVAsfbFLCUS5sGB3eO+9EFwjbjp/6EPWVVPiN
# zOCH3sAgdkQzkSQVm8ClxfjmiHc1HNBlCEu8qS4uFs6Q5Q/Ug0kqNfq82Xe8ee0T
# 1hbLowx0bTG3qJnKHV4ilYnggcbBLCu5zwuH2VF0HdB/lR4+gIw76DR0WacMOJ4o
# Je4ePcPE/HLSEdznhKz1ttdOm2hlPMQ99w9O+4I6jswaj94h8ly1j7U8tQhDMQwJ
# caooR5ehggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MTcxMTQ2MTBaMCMGCSqGSIb3DQEJBDEWBBTr50sQnyvrLZOoU0LWiBa5rRRwkzAN
# BgkqhkiG9w0BAQUFAASCAQBGFWSWmKX5r9bktfTqtpsSR5/gJ6BUlLvmW3Ff1ZmN
# 5Pc2TJhokdJG8FxvzEt/al+GuhTFI+tBO8EXS92R1ofDNedKb+bvC5faW+XY6aWQ
# fsFGV5gX0ig7nWV775bl8cEatkN7seSsgfmRn2+sjfQ6D5nBbmutukc9y420GDbx
# xfpKZ1X2o77YmHhGnQmIozOdIJXbExmrImnLnxTWrepDjC1AunVQAzHwHywotckp
# 65wu6bAKuifPOSfFwgXKyke99CpBFVi45qqjwsIk6EOmXkMoMt0E9Z4QoH3K4UfM
# X9cgAHxqKbI+EVs3c+HMWR/Zv8T/yjKjHs3hiCc5FvQD
